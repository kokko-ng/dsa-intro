...
TOPIC_15_TESTS: TestCasesDict = {
    ...
    "video_stitching": [
        {
            "args": [[[0, 2], [4, 6], [8, 10], [1, 9], [1, 5], [5, 9]], 10],
            "expected": 3,
            "name": "basic case",
        },
    ...
    "my_calendar_i": [
        {
            "args": [["book", "book", "book"], [[10, 20], [15, 25], [20, 30]]],
            "expected": [True, False, True],
            "name": "basic case",
            "compare": "calendar_ops",
        },
        {
            "args": [["book", "book", "book"], [[10, 20], [20, 30], [30, 40]]],
    ...
    "data_stream_disjoint_intervals": [
        {
            "args": [
                ["addNum", "addNum", "getIntervals", "addNum", "getIntervals"],
                [[1], [3], [], [2], []],
            ],
            "expected": [None, None, [[1, 1], [3, 3]], None, [[1, 3]]],
            "name": "basic case",
            "compare": "stream_interval_ops",
        },
    ],
    "range_module": [
        {
            "args": [
                ["addRange", "queryRange", "removeRange", "queryRange"],
                [[10, 20], [14, 16], [14, 16], [14, 16]],
            ],
            "expected": [None, True, None, False],
            "name": "basic case",
            "compare": "range_module_ops",
        },
    ],
    ...
    "add_bold_tag": [
        {
            "args": ["abcxyz123", ["abc", "123"]],
            "expected": "<b>abc</b>xyz<b>123</b>",
            "name": "basic case",
        },
        {
            "args": ["aaabbcc", ["aaa", "aab", "bc"]],
